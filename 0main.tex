...
\input{4related_works}

\chapter{Direct full-text extraction from PDF documents in Materials Science}
\label{cha:pdf_extraction}
\input{5pdf_extraction.tex}

\chapter{Extraction of material's related experimental data from scientific text}
\label{cha:extraction-experimental-data}
\label{subsubsec:extraction}
\input{6ner_materials}

\chapter{Extraction of properties and conditions as measurements of physical quantities}
\label{cha:measurements}
\input{7measurements.tex}

\chapter{SuperMat: Construction of a linked annotated dataset from superconductors-related publications}
\label{cha:supermat}
\input{8supermat}

\chapter{SuperCon\texorpdfstring{\textsuperscript{2}}{2} Database}
\label{cha:supercon2}
\input{9supercon2}

\chapter{SuperCon\texorpdfstring{\textsuperscript{2}}{2} Database data curation}
\label{cha:curation}
\input{10curation}
